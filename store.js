...
ListStore = {
  ...
  loadItems: function() {
      ...
      type: 'GET',
      url: "https://listalous.herokuapp.com/lists/Scavenger-Hunt/"
      })
  ...
  var creationRequest = $.ajax({
    type: 'POST',
    url: "http://listalous.herokuapp.com/lists/Scavenger-Hunt/items",
  ...
  toggleCompleteness: function(itemId) {
    ...
    var updateRequest = $.ajax({
      type: 'PUT',
      url: "https://listalous.herokuapp.com/lists/Scavenger-Hunt/items/" + itemId,
